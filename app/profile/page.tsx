              ...
              {createdParties.map((party) => {
                ...
                return (
                  <Link
                    key={party.id}
                    href={`/rooms/${party.id}`}
                    className="block border border-gray-200 rounded-lg p-4 hover:border-blue-500 hover:bg-blue-50 transition-colors"
                  >
              ...
              {joinedParties.map((party) => {
                ...
                return (
                  <Link
                    key={party.id}
                    href={`/rooms/${party.id}`}
                    className="block border border-gray-200 rounded-lg p-4 hover:border-green-500 hover:bg-green-50 transition-colors"
                  >
                    <div className="flex justify-between items-start">
                      <div>
                        <div className="flex items-center gap-2 mb-1">
