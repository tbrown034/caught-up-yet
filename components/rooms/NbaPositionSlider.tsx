...
import type { NbaPosition } from "@/lib/database.types";
import { formatNbaPosition } from "@/lib/game-position";

interface NbaPositionSliderProps {
  position: NbaPosition;
  onChange: (position: NbaPosition) => void;
}

export default function NbaPositionSlider({
  position,
  onChange,
}: NbaPositionSliderProps) {
    ...
    <div className="bg-white border border-gray-200 rounded-lg p-6">
      ...
      <div className="text-center mb-6">
        <p className="text-3xl font-bold text-blue-600">
          {formatNbaPosition({ quarter, minutes, seconds })}
        </p>
